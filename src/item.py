...
class Item:
    ...
    def name(self, name):
        ...
        # Не уверен, что такое решение верное :D, по крайней мере я не нашел, как менять вывод при рейзе ошибки
        # Но нашел, что искусственно вызывать ошибку и обрабатывать ее не лучшая практика
